...
<body>
	...
	<div id="main">
		...
		<div id="page">
			<div id="pages">
				<ul class="pagination">
					<li id="begin"><a href="score.do?ye=1&emp.name=${sc.emp.name}&emp.dep.id=${sc.emp!=null?sc.emp.dep.id:-1}&pro.id=${sc.pro!=null?sc.pro.id:-1}&grade=${sc.grade}">首页</a></li>
					<li id="pre"><a href="score.do?ye=${p.ye-1}&emp.name=${sc.emp.name}&emp.dep.id=${sc.emp!=null?sc.emp.dep.id:-1}&pro.id=${sc.pro!=null?sc.pro.id:-1}&grade=${sc.grade}">上一页</a></li>
					<c:forEach begin="${p.beginYe}" end="${p.endYe}" varStatus="status">
						<li <c:if test="${p.ye == status.index}">class="active"</c:if>><a
							href="score.do?ye=${status.index}&emp.name=${sc.emp.name}&emp.dep.id=${sc.emp!=null?sc.emp.dep.id:-1}&pro.id=${sc.pro!=null?sc.pro.id:-1}&grade=${sc.grade}">${status.index}</a></li>
					</c:forEach>
					<li id="next"><a href="score.do?ye=${p.ye+1}&emp.name=${sc.emp.name}&emp.dep.id=${sc.emp!=null?sc.emp.dep.id:-1}&pro.id=${sc.pro!=null?sc.pro.id:-1}&grade=${sc.grade}">下一页</a></li>
					<li id="end"><a href="score.do?ye=${p.maxYe}&emp.name=${sc.emp.name}&emp.dep.id=${sc.emp!=null?sc.emp.dep.id:-1}&pro.id=${sc.pro!=null?sc.pro.id:-1}&grade=${sc.grade}">末页</a></li>
				</ul>
			</div>
			<div id="message">
				<p>共${p.maxYe}页</p>
