   ...
   <div class="type_title">添加商品</div>
	<form action="addGoods.do" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class=" clearfix cl">
			...
			<div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="stock"></div>
            </div>
			<div class="Add_p_s">
            <label class="form-label col-2">销&nbsp;&nbsp;&nbsp;&nbsp;量：</label>
			<div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="salesVolume"></div>
            </div>
		...
		<div class="clearfix cl">
			...
			<div class="formControls col-10">
				<textarea name="details" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"></textarea>
                    ...
                    if ( stats.successNum ) {
                        ...
                        $.ajax({
                			...
                			success : function(data){
                				var str = "<input type='hidden' name='goodsImg.name' value='"+data+"''>";
