 ...
 <div class="transaction_style">
   <ul class="state-overview clearfix">
    <li class="Info">
     ...
     <span class="value"><h4>交易金额</h4><p class="Quantity color_red">${orderMoney }</p></span>
    </li>
     <li class="Info">
     ...
     <span class="value"><h4>交易成功</h4><p class="Quantity color_red">${count }</p></span>
    </li>
     <li class="Info">
     <span class="symbol yellow"><i class="fa fa-shopping-cart"></i></span>
     <span class="value"><h4>交易失败</h4><p class="Quantity color_red">0</p></span>
    </li>
     <li class="Info">
     <span class="symbol darkblue"><i class="fa fa-jpy"></i></span>
     <span class="value"><h4>退款金额</h4><p class="Quantity color_red">0.00</p></span>
    </li>
   </ul>
