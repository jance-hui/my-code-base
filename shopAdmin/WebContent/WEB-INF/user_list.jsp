...
<div class="page-content clearfix">
    ...
    <div class="search_style">
      ...
      <ul class="search_content clearfix">
       <li><label class="l_f">会员名称</label><input name="name" type="text" value="${user.name }" class="text_add" placeholder="输入会员名称"  style=" width:400px"/></li>
	...
	<tbody>
		...
		<tr>
          ...
          <td>${user.id}</td>
          <td><u style="cursor:pointer" class="text-primary" onclick="member_show('${user.username }','member-show.do','${user.id}','500','400')">${user.username }</u></td>
          <td>${user.name }</td>
          <td>${user.phone}</td>
          ...
          <a title="编辑" onclick="member_edit('${user.id}')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
...
<div class="add_menber" id="add_menber_style" style="display:none">
    <ul class=" page-content">
     ...
     <li><label class="label_name">密&nbsp;&nbsp;&nbsp; &nbsp;码：</label><span class="add_name"><input value="" name="password" type="password"  class="text_add"/></span><div class="prompt r_f"></div></li>
 ...
 $('#member_add').on('click', function(){
    layer.open({
		...
		yes:function(index,layero){	
     		...
     		var username=$(".add_menber").find("[name=username]").val();
     		var password=$(".add_menber").find("[name=password]").val();
     		var name=$(".add_menber").find("[name=name]").val();
     		var phone=$(".add_menber").find("[name=phone]").val();
     		var user={
     				id:null,
     				username:username,
     				password:password,
