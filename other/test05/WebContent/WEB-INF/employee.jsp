...
<body>
	<div id="main">
		...
		<div>
			...
			<input id="showUpdate" class="btn btn-primary" type="button"
				value="修改"> <input id="del" class="btn btn-primary"
				type="button" value="删除"> <input id="showUpdateBatch"
				class="btn btn-primary" type="button" value="转页修改"> <input
				id="updateBatch" class="btn btn-primary" type="button" value="直接修改">
			<input id="delBatch" class="btn btn-primary" type="button"
				value="批量删除"> <input id="find" class="btn btn-primary"
