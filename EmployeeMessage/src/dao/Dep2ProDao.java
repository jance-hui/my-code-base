...
public class Dep2ProDao extends BaseDao {
	...
	public List<Project> searchByDepartment(Department dep) {// 查询
	...
	public List<Project> searchByNotDepartment(Department dep) {// 查询未有的项目
	...
	public boolean add(Project pro, Department dep) {// 添加
		boolean flag = false;
		getConnection();
		try {
			int rs = stat
	...
	public boolean del(Project pro, Department dep) {// 删除
		boolean flag = false;
		getConnection();
		try {
