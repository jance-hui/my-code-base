     ...
     <div class="side_list">
      ...
      <div class="widget-body">
         <ul class="b_P_Sort_list">
             <li><i class="orange  fa fa-user-secret"></i><a href="advertising.do">全部</a></li>
             <c:forEach items="${goodsList2 }" var="goodss">
             <li><i class="fa fa-image pink "></i> <a href="advertising.do?id=${goodss.id}">${goodss.name }</a></li>
             </c:forEach>
         </ul>
  </div>
  </div>
   ...
   <div class="border clearfix">
	...
	<c:forEach items="${goods.goodsImgs}" var="img">
      <tr>
       ...
       <td>${img.id}</td>
       <td><input name="" type="text"  style=" width:50px" placeholder="${img.sort}"/></td>
       <td>${goods.name }</td>
       <td><span class="ad_img"><img src="goodsImg/${img.name }"  style="width:100px;height:100px;"/></span></td>
       <td>1890x1080</td>
