  ...
  <div class="sort_list">
	...
	<c:forEach items="${goodsList }" var="goods">
      ...
      <tr>
       ...
       <td>${goods.name }</td>
       <td>${img.sort}</td>
       <td><img src="goodsImg/${img.name }" style="width:30px;height:30px;">${goods.details}</td>
      ...
      <td class="td-manage">
        ...
        <a href="javascript:ovid()" class="btn btn-xs btn-pink ads_link" onclick="AdlistOrders('561');" title="幻灯片广告列表"><i class="fa  fa-bars  bigger-120"></i></a>
       </td>
      </tr>
     	 </c:forEach>
      </c:forEach>
