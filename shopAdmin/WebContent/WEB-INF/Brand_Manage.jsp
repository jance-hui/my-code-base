  ...
  <div id="brand_style">
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="Add_Brand.do"  title="添加品牌" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加品牌</a>
	...
	<tbody>
		...
		<tr>
          ...
          <td><a href="javascript:ovid()" name="Brand_detailed.do" style="cursor:pointer" class="text-primary brond_name" onclick="generateOrders('${brand.id}');" title="${brand.name}">${brand.name}</a></td>
          <td>法国</td>
          ...
          <a title="编辑" onclick="member_edit('编辑','brandUpdate.do','${brand.id}','','510')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
          <a title="删除" href="javascript:;"  onclick="member_del(this,'${brand.id}')" class="btn btn-xs btn-warning" ><i class="icon-trash  bigger-120"></i></a>
          </td>
		</tr>
		</c:forEach>
        </tbody>
...
function generateOrders(id){
	window.location.href = "Brand_detailed.do?id="+id;
};
/*品牌-查看*/
