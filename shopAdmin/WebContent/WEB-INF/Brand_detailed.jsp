   ...
   <form>
    <ul class="Info_style clearfix">
     <li><label class="label_name">品牌名称：</label> <span class="name">${brand.name}</span></li>
      ...
      <li class="b_Introduce"><label class="label_name">品牌介绍：</label><span class="name">${brand.name}，是宝洁公司全球著名的护肤品牌，是中国区最大护肤品牌，在大陆已持续十年呈两位数增长。OLAY以全球高科技护肤研发技术为后盾，在深入了解中国女性对护肤和美的需要的基础上，不断扩大产品范围，目前已经涵盖了护肤和沐浴系列，真正帮助女性全面周到地呵护自己的肌肤。玉兰油全球销售额近十亿美金，成为世界上最大、最著名的护肤品牌之一。卓越的护肤功效获得世界爱美女性肯定，迅速畅销150多个国家。</span></li>
    </ul>
         ...
         <div class="side_list">
          ...
          <div class="widget-body">
            <ul class="b_P_Sort_list">
             <li><i class="orange icon-folder-close"></i><a href="#">全部(235)</a></li>
